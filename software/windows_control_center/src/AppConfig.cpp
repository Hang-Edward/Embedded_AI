...
void AppConfig::load() {
    ...
    lastExternalConversationKey = settings.value("chat/lastExternalConversationKey").toString();
}
...
void AppConfig::save() const {
    ...
    settings.setValue("chat/lastExternalConversationKey", lastExternalConversationKey);
}
